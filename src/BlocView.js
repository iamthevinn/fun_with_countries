    ...
    return (
      <div>
        ...
        <div className="columns small-10 padding-medium rightHome">
          ...
          <div>
            {this.props.blocData.map((country) => <CountryCard key={country.alpha3Code} onBloc={true} history={this.props.history} match={this.props.match} trackedCountry={this.props.trackedCountries.find((trackedCountry) => trackedCountry.countryName === country.name)} country={country} />)}
          </div>
        </div>
      </div>
    );
